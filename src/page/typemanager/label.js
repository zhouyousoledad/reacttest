...
import { labellist, labeladd, labeleduit, labeldelete } from '../../axios/label';
import './type.css';
...
import Details from './labeldetail.js'
const { confirm } = Modal;
...
const validateName = (rule, value) => {
    ...
    <Modal title={this.state.vtitle} visible={this.state.visible} onOk={this.otherBtnClick} onCancel={this.cancel} okText="确定" cancelText="取消">
       ...
       <Form {...layout} ref={this.formRef}>
            <Form.Item label="标签名称" name='name' rules={[{required: true, validator: validateName}]}>
              <Input placeholder='请输入' />
            </Form.Item>
			<Form.Item label="标签编码" name='labelCode' rules={[{required: true, validator: validateName}]}>
              <Input placeholder='请输入' />
            </Form.Item>
